---
title: How to Track WhatsApp Messages on Vivo X90S Without Them Knowing? | Dr.fone
date: 2024-07-21T22:10:34.652Z
updated: 2024-07-22T22:10:34.652Z
tags: 
  - virtual location change
  - location track
categories:
  - android
description: This article describes How to Track WhatsApp Messages on Vivo X90S Without Them Knowing?
excerpt: This article describes How to Track WhatsApp Messages on Vivo X90S Without Them Knowing?
keywords: Location Track for X90S,track location
thumbnail: https://thmb.techidaily.com/9420d8c67dc649498f45244e433ec706e66933c2bf2f2b4b3c5585601cba7b98.jpg
---

## How to Track WhatsApp Messages on Vivo X90S Without Them Knowing?
...
[WhatsApp Web](https://drfone.wondershare.com/whatsapp/whatsapp-web-not-working.html) is a feature provided by WhatsApp. It allows users to access their WhatsApp accounts on a web browser. That makes it a convenient way to track WhatsApp messages remotely. However, it is as long as you can access the target device for the initial setup. To set up WhatsApp Web, you will need physical access to the Vivo X90S device on which the targeted WhatsApp account is active.
...
Finally, point the Vivo X90S device's camera toward the QR code displayed on the web page. Once the code is scanned, the WhatsApp account will be mirrored on the web browser. You need to get physical access to the targeted device. Also, the Vivo X90S device must remain connected to the internet.
...
Launch WhatsApp on the Vivo X90S device, go to the menu, and select "Linked Devices." Now tap "Link a device" and use the QR code scanner to scan the code on your device. Once devices are linked, it will allow you to track the WhatsApp messages of the targeted person. Using this method needs physical access to the targeted device along with stable internet.
...
To use this method, you will need to physically access the Vivo X90S device or need a device with the targeted Google account logged in. Here navigate to Google Drive and find the WhatsApp backup file. Download these files on your device and use a third-party tool to decrypt the files.
...
**Step 1:** After selecting "Android" as the smartphone type, get physical access to the Vivo X90S device. Now enable “Installation from Unknown Sources” and disable Google Play Protect. When done, tap “Proceed” in your mSpy account, which will take you to a screen with the URL.
...
**Step 3:** After the URL is open, you will see a CAPTCHA, which you need to verify. Now use "Download" to start downloading the APK file, and once it is downloaded, install it on the Vivo X90S device. Open the app after it is installed and agree to the terms & conditions.
...
**Step 1:** For iPhone, you can choose either jailbroken or non-jailbroken as the Vivo X90S device type. Since you need to read WhatsApp messages, choosing non-jailbroken is sufficient. For mSpy to work on non-jailbroken iPhones, the iCloud backup should be enabled. You will also need Apple ID credentials and physical access in case of 2FA.
...
<!-- affiliate ads end -->
## How to Track a Lost Vivo X90S for Free?
...
But before we move ahead and explain how to track your lost phone for free with iCloud, we should tell you that it is limited in its cell location tracking and other features in that it will only send a message to the Vivo X90S device, lock or erase it, and not provide records of information traffic going in and out of the Vivo X90S device. Here’s how to track lost iPhones for free.
...
Step 3. That’s really all there is to it! Once you select your device, you can do one of three things—play sound, activate lost mode or erase the Vivo X90S device to prevent compromise of information.
...
If you’ve misplaced your Vivo X90S cell phone, have no fear, because there are few ways to help you track its location. There are a few things to do before you can begin tracking an Android device such as have an active and connected Google account (something you already set up when you bought the Vivo X90S device), and locations services on the Vivo X90S device enabled. Even though your mobile manufacturer may offer their own exclusive solution to track your phone, Google’s Find My Device (formerly Android Device Manager) is probably the most easiest and trusted way to go with. Here’s how to track your lost phone with Google’s ADM.
...
<!-- affiliate ads end -->
![Track with Google’s ADM-activate the Vivo X90S device](https://images.wondershare.com/drfone/article/2017/10/15080424126895.jpeg)
...
## Best Anti Tracker Software For Vivo X90S
...
It’s true that a part of you is out in the open once you go online and surf the internet. Supposedly, there should be no issue regarding that. However, some people steal information and put it to bad use. That’s why you should be careful every time you connect your Vivo X90S to the internet. Install and activate any of the anti-tracker software listed above. For sure, it can help you a lot. As for your location, try to download Wondershare Dr.Fone for free. Take advantage of its Virtual Location feature capable of modifying your location and simulating GPS movements.
