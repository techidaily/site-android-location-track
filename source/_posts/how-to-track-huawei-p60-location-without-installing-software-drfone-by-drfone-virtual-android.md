---
title: How to Track Huawei P60 Location without Installing Software? | Dr.fone
date: 2024-04-12T12:56:29.988Z
updated: 2024-04-13T12:56:29.988Z
tags: 
  - virtual location change
  - location track
categories:
  - android
description: This article describes How to Track Huawei P60 Location without Installing Software?
excerpt: This article describes How to Track Huawei P60 Location without Installing Software?
keywords: Location Track for P60,track location
thumbnail: https://www.lifewire.com/thmb/RWcl_Joktvj_rmr9ViWUZrsB7e4=/400x300/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/homepod-hero-5a79bc226bf06900378a7e1a.jpg
---

## How to Track Huawei P60 Location without Installing Software?
...
Step 5. From here, you will need to click the dropdown labeled All Devices and select the target device. Once you select the Huawei P60 device you wish to locate, you can either erase your iPhone, send an audible alert or lock the Huawei P60 device.

![track a cell phone-select the Huawei P60 device you wish to locate](https://images.wondershare.com/drfone/article/2017/10/15082095893194.jpeg)
...
Step 1. As long as you have your Google account connected with your Huawei P60 (again something you will have done when you first received the phone), you can now begin tracking by heading to Find My Device on the web.
...
Step 1. Open the main Google search page and type in "find My Huawei P60", and you should be presented with results showing your cell phone’s location.
...
## How to Track WhatsApp Messages on Huawei P60 Without Them Knowing?
...
[WhatsApp Web](https://drfone.wondershare.com/whatsapp/whatsapp-web-not-working.html) is a feature provided by WhatsApp. It allows users to access their WhatsApp accounts on a web browser. That makes it a convenient way to track WhatsApp messages remotely. However, it is as long as you can access the target device for the initial setup. To set up WhatsApp Web, you will need physical access to the Huawei P60 device on which the targeted WhatsApp account is active.
...
Finally, point the Huawei P60 device's camera toward the QR code displayed on the web page. Once the code is scanned, the WhatsApp account will be mirrored on the web browser. You need to get physical access to the targeted device. Also, the Huawei P60 device must remain connected to the internet.
...
Launch WhatsApp on the Huawei P60 device, go to the menu, and select "Linked Devices." Now tap "Link a device" and use the QR code scanner to scan the code on your device. Once devices are linked, it will allow you to track the WhatsApp messages of the targeted person. Using this method needs physical access to the targeted device along with stable internet.
...
To use this method, you will need to physically access the Huawei P60 device or need a device with the targeted Google account logged in. Here navigate to Google Drive and find the WhatsApp backup file. Download these files on your device and use a third-party tool to decrypt the files.
...
**Step 1:** After selecting "Android" as the smartphone type, get physical access to the Huawei P60 device. Now enable “Installation from Unknown Sources” and disable Google Play Protect. When done, tap “Proceed” in your mSpy account, which will take you to a screen with the URL.
...
**Step 3:** After the URL is open, you will see a CAPTCHA, which you need to verify. Now use "Download" to start downloading the APK file, and once it is downloaded, install it on the Huawei P60 device. Open the app after it is installed and agree to the terms & conditions.
...
**Step 1:** For iPhone, you can choose either jailbroken or non-jailbroken as the Huawei P60 device type. Since you need to read WhatsApp messages, choosing non-jailbroken is sufficient. For mSpy to work on non-jailbroken iPhones, the iCloud backup should be enabled. You will also need Apple ID credentials and physical access in case of 2FA.
...
### Method 1: Turn off the location services on your Huawei P60 mobile device
